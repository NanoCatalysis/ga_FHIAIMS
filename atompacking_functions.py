...
def complete_cicle_mutation(file_dirs ="", Atom = "Au", Size = 52, path ="",cores= 16 ):
	...
	Mutate(data_last_step= data_last_step, path = path, name=f"{Atom+str(Size)}", cores =cores, file_energies=file_energies, Atom =Atom, Size=Size)
	Cicle_mutation(data_last_step= data_last_step, path = path, name=f"{Atom+str(Size)}", cores =16, file_energies=file_energies, Atom =Atom, Size=Size)
